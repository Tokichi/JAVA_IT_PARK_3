...
public class TeacherDaoJdbcTemplateImpl implements TeacherDao {
    ...
    //language=SQL
    private static final String SQL_INSERT_TEACHER = "INSERT INTO teacher(name, surname, patronymic, login, password, email)" + "VALUES (?, ?, ?, ?, ?, ?)";
    //language=SQL
        ...
        template.update(
                new PreparedStatementCreator() {
                    ...
                    public PreparedStatement createPreparedStatement(Connection connection) throws SQLException {
                        PreparedStatement preparedStatement = connection.prepareStatement(SQL_INSERT_TEACHER, new String[]{"id"});
